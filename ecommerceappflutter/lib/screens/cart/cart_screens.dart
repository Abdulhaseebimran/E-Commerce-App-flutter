...
import 'package:ecommerceappflutter/screens/cart/components/body.dart';
...
class CartScreens extends StatelessWidget {
  ...
  static String routeName = "/CartScreens";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Body(),
      bottomNavigationBar: CheckOurCards(),
    );
  }
...
class CheckOurCards extends StatelessWidget {
  const CheckOurCards({
    Key? key,
  }) : super(key: key);
